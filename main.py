...
print("welcome to the betting simulator!")
...
while True:
  ...
  if amount_money<=0 and total_num_of_stock==0:
    print("you are fully bankrupt thank you for playing GAME OVER :'(.....wait there is one more option, you could sell a few things")
  ...
  if days==yoink:
    ...
    print("You lost a quarter of your money in a data leak :( I know this seems bad but this is the perfect time to get back and start trading again")